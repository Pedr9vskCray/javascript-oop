...
function relatorio(conta){
    validate(conta, Comum);
    console.log(`Número: ${conta.numero}`);
    console.log(`Saldo: ${conta.saldo}`);
    if (conta instanceof Limite){
        console.log(`Limite: ${conta.limite}`);
    }
    return
}

let conta1 = new Comum("a1b2c3", 14486);

relatorio(conta1);

console.log("\n");

let conta2 = new Limite("d4e5f6", 23455, 2500);

relatorio(conta2);

console.log("\n")

conta2.retirada(25000);
